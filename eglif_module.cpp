...
/*
 * There are three scenarios, in which eglifModule can be loaded by NEST:
 *
...
eglif_nest::eglif_module eglif_module_LTX_mod;
#endif
// -- DynModule functions ------------------------------------------------------

eglif_nest::eglif_module::eglif_module()
{
#ifdef LINKED_MODULE
...
const std::string
eglif_nest::eglif_module::name( void ) const
{
  return std::string( "E-GLIF NEST Module" ); // Return name of the module
}

const std::string
eglif_nest::eglif_module::commandstring( void ) const
{
  // Instruct the interpreter to load eglif_module-init.sli
  return std::string( "(eglif_module-init) run" );
}

//-------------------------------------------------------------------------------------

void
eglif_nest::eglif_module::init( SLIInterpreter* i )
{
  ...
  */
  ...
  nest::kernel().model_manager.register_node_model< eglif_cond_alpha_multisyn_vmin >(
    "eglif_cond_alpha_multisyn_vmin" );

  nest::kernel().model_manager.register_node_model< eglif_cond_alpha_multisyn_rng >(
