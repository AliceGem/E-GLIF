...
/*
*  eglif_cond_alpha_multisyn_rng.h
*
...
#ifndef EGLIF_COND_ALPHA_MULTISYN_RNG
#define EGLIF_COND_ALPHA_MULTISYN_RNG
...
/*
extern "C" inline int
eglif_cond_alpha_multisyn_rng_dynamics(double, const double*, double*,
                                          void *pnode);*/
...
/* BeginDocumentation
Name: eglif_cond_alpha_multisy_rng .

//
Name: eglif_cond_alpha_multisyn_rng - Extended Generalized Leaky
integrate-and-fire neuron model with multiple ports based on [Mihalas and Niebur,
2009] and [Hertag et al, 2012]; described in [Geminiani, Casellato et al., 2018], using rng of NEST for rnd number generation

Description:

 eglif_cond_alpha_multisyn_rng from iaf_psc_exp_multisynapse_nestml.

Sends: SpikeEvent

Receives: SpikeEvent, CurrentEvent, DataLoggingRequest

Author:  Geminiani and Casellato, adapted from iaf_psc_exp_multisynapse and iaf_psc_alpha_multisyn and iaf_cond_alpha for the synapses;
...
Empty
*/
class eglif_cond_alpha_multisyn_rng : public nest::Archiving_Node {
public:
  /**
  * The constructor is only used to create the model prototype in the model
  * manager.
  */
  eglif_cond_alpha_multisyn_rng();
  ...
  */
  eglif_cond_alpha_multisyn_rng(const eglif_cond_alpha_multisyn_rng &);
...
// Parameters for sinusoidal Ie per STO
  ...
  inline nest::RingBuffer &get_currents() { return B_.get_currents(); };
		...
		//protected: // modificato in private: come in pif_psc_alpha
...
protected:
  ...
  friend class nest::RecordablesMap< eglif_cond_alpha_multisyn_rng >;
  friend class nest::UniversalDataLogger< eglif_cond_alpha_multisyn_rng >;
  ...
  */
  struct Parameters_ {
   ...
   double tau_syn3; //
    ...
    //! Store parameter values in dictionary.				// Aggiunto come in pif_psc_alpha
  ...
  */
   ...
   * that
    ...
    */
  struct Buffers_ {
    Buffers_(eglif_cond_alpha_multisyn_rng &);
    Buffers_(const Buffers_ &, eglif_cond_alpha_multisyn_rng &);
    ...
    nest::UniversalDataLogger<eglif_cond_alpha_multisyn_rng> logger_;
...
//private:
  ...
  */
  ...
  static nest::RecordablesMap<eglif_cond_alpha_multisyn_rng> recordablesMap_;

  friend int eglif_cond_alpha_multisyn_rng_dynamics(double, const double y[],
                                                       double f[], void *pnode);
 // friend int eglif_cond_alpha_multisyn_rng_dynamics(double, const double*,
  //                                                     double*, void *pnode);

  /** @} */
}; /* neuron eglif_cond_alpha_multisyn_rng */

inline nest::port 
eglif_cond_alpha_multisyn_rng::send_test_event(
...
//   Questa funzione non c'è nell'AEIF cond alpha multisyn_rng
inline nest::port
eglif_cond_alpha_multisyn_rng::handles_test_event(nest::SpikeEvent &,
...
inline nest::port
eglif_cond_alpha_multisyn_rng::handles_test_event(nest::CurrentEvent &,
                                                     nest::port receptor_type) {
  // You should usually not change the code in this function.
...
inline nest::port eglif_cond_alpha_multisyn_rng::handles_test_event(
...
inline void
eglif_cond_alpha_multisyn_rng::get_status(DictionaryDatum &__d) const {
...
inline void
eglif_cond_alpha_multisyn_rng::set_status(const DictionaryDatum &__d) {
...
#endif /* #ifndef eglif_cond_alpha_multisyn_rng */
#endif /* HAVE GSL */
