...
/*
*  eglif_cond_alpha_multisyn_vmin.h
*
...
#ifndef EGLIF_COND_ALPHA_MULTISYN_VMIN
#define EGLIF_COND_ALPHA_MULTISYN_VMIN
#include "config.h"
...
/*
extern "C" inline int
eglif_cond_alpha_multisyn_vmin_dynamics(double, const double*, double*,
                                          void *pnode);*/
...
/* BeginDocumentation
Name: eglif_cond_alpha_multisyn_vmin .

//
Name: eglif_cond_alpha_multisyn_vmin_nestml - Generalized Leaky
integrate-and-fire neuron model with
                                 multiple ports based on [Mihalas and Niebur,
2009].

Description:

eglif_cond_alpha_multisyn_vmin_nestml from iaf_psc_exp_multisynapse_nestml.
...
Empty
*/
class eglif_cond_alpha_multisyn_vmin : public nest::Archiving_Node {
public:
  /**
  * The constructor is only used to create the model prototype in the model
  * manager.
  */
  eglif_cond_alpha_multisyn_vmin();
  ...
  */
  eglif_cond_alpha_multisyn_vmin(const eglif_cond_alpha_multisyn_vmin &);
...
protected:
  ...
  friend class nest::RecordablesMap<eglif_cond_alpha_multisyn_vmin>;
  friend class nest::UniversalDataLogger<eglif_cond_alpha_multisyn_vmin>;
  ...
  */
   ...
   * that
    ...
    */
  struct Buffers_ {
    Buffers_(eglif_cond_alpha_multisyn_vmin &);
    Buffers_(const Buffers_ &, eglif_cond_alpha_multisyn_vmin &);
    ...
    nest::UniversalDataLogger<eglif_cond_alpha_multisyn_vmin> logger_;
...
private:
  ...
  */
  ...
  static nest::RecordablesMap<eglif_cond_alpha_multisyn_vmin> recordablesMap_;

  friend int eglif_cond_alpha_multisyn_vmin_dynamics(double, const double y[],
                                                       double f[], void *pnode);
 // friend int eglif_cond_alpha_multisyn_vmin_dynamics(double, const double*,
  //                                                     double*, void *pnode);

  /** @} */
}; /* neuron eglif_cond_alpha_multisyn_vmin */

inline nest::port eglif_cond_alpha_multisyn_vmin::send_test_event(
...
inline nest::port
eglif_cond_alpha_multisyn_vmin::handles_test_event(nest::SpikeEvent &,
...
inline nest::port
eglif_cond_alpha_multisyn_vmin::handles_test_event(nest::CurrentEvent &,
                                                     nest::port receptor_type) {
  // You should usually not change the code in this function.
...
inline nest::port eglif_cond_alpha_multisyn_vmin::handles_test_event(
...
inline void
eglif_cond_alpha_multisyn_vmin::get_status(DictionaryDatum &__d) const {
...
inline void
eglif_cond_alpha_multisyn_vmin::set_status(const DictionaryDatum &__d) {
...
#endif /* #ifndef EGLIF_COND_ALPHA_MULTISYN_VMIN  */
#endif /* HAVE GSL */
