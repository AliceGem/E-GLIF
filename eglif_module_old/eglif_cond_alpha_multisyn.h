...
//
Name: eglif_cond_alpha_multisyn - Extended Generalized Leaky
integrate-and-fire neuron model with multiple ports based on [Mihalas and Niebur,
2009] and [Hertag et al, 2012]; described in [Geminiani, Casellato et al., 2018]

Description:

 eglif_cond_alpha_multisyn from iaf_psc_exp_multisynapse_nestml.
...
inline nest::port 
eglif_cond_alpha_multisyn::send_test_event(
