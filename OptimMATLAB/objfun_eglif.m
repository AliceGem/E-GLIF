...
%OBJFUN compute the sum of squared errors over the depolarizing phases for
%latency, onset and steady-state firing period:
% sq_erN_'phase' = 'phase' during depN
...
%     global area_real1
    ...
    %Valori ricavati analiticamente da parametri oscillazioni
    %k_adap_des = -0.281;
    %Ie_des = ;
    %k2_des = ;
...
%         c3
    ...
    % Da valutare se metterlo nell'ottimizzazione o no
    
    % AHP duration: att!! Prendiamo il valore di regime che � il valore
    % attorno a cui oscilla Vm; diverso se non abbiamo oscillazioni!
    % AHP1
