...
mynest::EglifModule eglifmodule_LTX_mod;
#endif
// -- DynModule functions ------------------------------------------------------

mynest::EglifModule::EglifModule()
{
#ifdef LINKED_MODULE
...
const std::string
mynest::EglifModule::name( void ) const
{
  return std::string( "E-GLIF Module" ); // Return name of the module
}

const std::string
mynest::EglifModule::commandstring( void ) const
{
  // Instruct the interpreter to load eglifmodule-init.sli
  return std::string( "(eglifmodule-init) run" );
}

//-------------------------------------------------------------------------------------

void
mynest::EglifModule::init( SLIInterpreter* i )
{
